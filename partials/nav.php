<nav class="bg-background shadow p-5">
    <div class="container mx-auto px-6 py-3 md:flex md:justify-between md:items-center">
        <div class="flex justify-between items-center">
            <div>
            <a class="text-second-main text-xl font-bold md:text-2xl hover:text-second-main" href="./index.php">Fruitask</a>
            </div>
            <!-- Mobile menu button -->
        ...
        <div class="md:flex items-center">
            ...
            <a class="my-1 text-sm text-second-main font-medium hover:text-second-main md:mx-4 md:my-0" href="./index.php">Home</a>
            ...
            <div class="flex justify-center md:block">
                <a class="relative text-second-main hover:text-gray-600" href="./add_cart.php">
